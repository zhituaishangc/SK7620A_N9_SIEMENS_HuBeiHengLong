...
//M(Mask18/$85020/"panel_18_4_chs.png"/)
	...
	DEF VAR8=(R3/-2000,2000//$85027,$85027,$85043,/WR2/"panel_blank_chs.png"/"$R[277]"/360,100,202/460,100,60/);磨削长度
	...
	DEF WHELL_POS_INI=(R///$85169,$85169,$85043,/WR2/"panel_18_27_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[14]"/10,350,210/120,350,60/);初始磨削接触位(对刀完成后磨削接触位)

	DEF GunDaoZuoYouTiaoZheng=(R///$85176,$85176,$85043,/WR2/"panel_blank_chs.png"/"$R[278]"/210,310,180/290,310,60/);滚道左右调整量,通过转C实现			
	DEF C_POS_USED=(R/0,360//$85173,$85173,$85042,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[5]"/210,330,180/290,330,60/);C轴起始角度
	DEF C_POS_INPUT=(R/0,360//$85174,$85174,$85042,/WR2/"panel_18_28_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[41]"/210,350,180/290,350,60/);手动输入的C起始角
...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/330,240,110/440,240,110/);砂轮当前直径
...
//M(Mask19/$85379/"panel_19_1_chs.png"/)
	...
	DEF VAR11=(R/0,80//$85332,$85332,,$85047/WR2/"panel_19_1_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[19]"/325,90,110/440,90,110/);滚压轮停留时间
	DEF VAR7=(R/0,500//$85396,$85396,,$85043/WR2/"panel_19_5_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[1]"/325,110,110/440,110,110/);修整轮直径
	DEF VAR8=(R/0,60//$85397,$85397,,$85046/WR2/"panel_19_6_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[2]"/325,130,110/440,130,110/);修整轮线速度
	DEF VAR9=(I///$85325,$85325,,$85044/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[20]"/325,150,110/440,150,110/);修整轮转速

	DEF VAR1=(R/-500,500//$85334,$85334,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[13]"/255,240,180/440,240,65/);新砂轮开始修整接触坐标
	DEF VAR6=(R/-500,500//$85335,$85335,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[22]"/255,260,180/440,260,65/);新砂轮修整到位后坐标	
	DEF VAR3=(R/-500,500//$85399,$85399,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/255,280,180/440,280,65/);当前接触坐标
	DEF VAR5=(R/-500,500//$85333,$85333,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[21]"/255,300,180/440,300,65/);修到最小时的接触坐标
...
//M(Mask21/$85026/"panel_21_2_chs.png"/)
	...
	DEF VAR3=(R/0,359//$85504,$85504,,$85042/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/INI[50]"/330,90,110/440,90,110/);内螺纹测头自动对刀工件C方向合适角度
	DEF CeTouXJiChuZuoBiao=(R/-500,500//$85529,$85529,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[45]"/250,110,190/440,110,60/);探头感应到信号时的X坐标
	...
	DEF VAR4=(R/0,500//$85505,$85505,,$85043/WR4/"panel_21_6_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/330,150,110/440,150,110/);内螺纹测头球中心/接近开关探测面与磨杆距离(X向)
	...
	DEF DuiDaoTiaoZheng=(R///$85063,$85063,,$85043/WR2/"panel_blank_chs.png"/"$R[279]"/330,190,110/440,190,110/);对刀结果调整,通过动起点实现
	...
	DEF VAR20=(R///$85524,$85524,,$85042/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[38]"/330,310,110/440,310,110/);接近开关接触第一个齿C坐标
	DEF VAR21=(R///$85525,$85525,,$85042/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[39]"/330,330,110/440,330,110/);接近开关接触第二个齿C坐标
	DEF VAR22=(R///$85526,$85526,,$85042/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[40]"/330,350,110/440,350,110/);接近开关接触齿底C坐标

	DEF VAR25=(R///$85524,$85524,,$85043/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[38]"/330,310,110/440,310,110/);接近开关接触第一个齿C坐标
	DEF VAR26=(R///$85525,$85525,,$85043/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[39]"/330,330,110/440,330,110/);接近开关接触第二个齿C坐标
	DEF VAR27=(R///$85526,$85526,,$85043/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[40]"/330,350,110/440,350,110/);接近开关接触齿底C坐标
